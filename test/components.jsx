...
const IntlValidIdWithVariables = ({ intl }) => (
    <div>
        <span>{intl.locale}</span>
        <span>{intl.formatMessage({ id: 'test' }, { role: 'engineer', role2: 'teacher' })}</span>
    </div>
)
...
export { IntlValidId, IntlValidIdWithVariables, IntlInvalidId, IntlInvalidIdWithDefaultMessage }
